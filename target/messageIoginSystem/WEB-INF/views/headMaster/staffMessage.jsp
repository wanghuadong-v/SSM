...
<div style="background: #f0ad4e">
    <h1 align="center">招聘人员列表</h1>
</div>
<br>
<br>

<div align="center">
    <table class="layui-table" lay-data="{width: 1300, height:500,url:'/allStaff?headMaster=true', page:true,id:'idTest'} "
           lay-filter="demo">
        <thead>
        <tr>
            <th lay-data="{field:'R', width:80, fixed: true, align : 'center'}">序号</th>
<%--                        <th lay-data="{field:'eid', width:150, fixed: true}">员工编号</th>--%>
            <th lay-data="{field:'ename', align : 'center'}">员工姓名</th>
            <th lay-data="{field:'tel', align : 'center'}">联系电话</th>
                        ...
                        <form action="">
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-sm-2" style="display: inline-block" >员工编号</label>
                                    <div class="col-sm-5" >
                                        <input type="text" class="layui-input" id="staffId" disabled>
                                    </div>
                                </div>
                            </div>
                            <br/>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="layui-input" id="staffName" disabled>
                                    </div>
                                </div>
                            </div>
                            <br/>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="layui-input" id="staffTel" disabled>
                                    </div>
                                </div>
                            </div>
                            <br/>
