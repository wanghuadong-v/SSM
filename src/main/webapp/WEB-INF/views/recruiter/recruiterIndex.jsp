...
<div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
        ...
        <ul class="layui-nav layui-nav-tree"  lay-filter="test">
            <li class="layui-nav-item" ><a href="/toSchoolMessage2" target="showContent"  style="text-decoration-line: none">高校管理</a></li>
            <li class="layui-nav-item" ><a href="/toLeaderMessage2"  target="showContent"  style="text-decoration-line: none">负责人管理</a></li>
            <li class="layui-nav-item" ><a href="/toClassMessage2"  target="showContent"  style="text-decoration-line: none">班级管理</a></li>
            <li class="layui-nav-item"><a href="/toStudentMessage2"  target="showContent"  style="text-decoration-line: none">学员管理</a></li>
        </ul>
    </div>
</div>
